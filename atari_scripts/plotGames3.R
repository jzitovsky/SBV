...
args = c('Asterix3', 'Breakout3', 'Pong4', 'Seaquest4')
...
breakout_plot = plot_game(target_table_breakout, sbv_table_breakout, wis_table_breakout, env='Breakout', jitter2=T)
...
pdf(file="game_plot3.pdf", width=13, height=4)
plot(game_plot)
dev.off()
